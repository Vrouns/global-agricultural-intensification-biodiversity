...
country_shapes = gpd.read_file("H:/02_Projekte/allgemein_biodiversity_impact/02_data/country_shp/ne_110m_admin_0_countries.shp")
...
def calculate_lu_intensity_per_country (input_folder, output_folder, status_log_file,country_raster,country_shapes): 
    ...
    # loop over countries
        ...
        # Create a DataFrame in one go
            ...
            if status_log_file is not None:
...
input_folder = "data/03_intensity/LUH2_GCB2025/crops/" # folder where the unprocessed area data is stored 
output_folder = "output/area_intensity/LUH2_GCB2025/"
#status_log_file = "data/03_intensity/LUH2/status_log/status_log.csv"  
calculate_lu_intensity_per_country(input_folder = input_folder, 
...
input_folder = "data/03_intensity/LUH2_GCB2025/plantations/" # folder where the unprocessed area data is stored 
calculate_lu_intensity_per_country(input_folder = input_folder, 
                                   output_folder = output_folder, 
                                   status_log_file=None,
                                   country_raster = country_raster,
                                   country_shapes = country_shapes)
# same for pasture
input_folder = "data/03_intensity/LUH2_GCB2025/pasture/" # folder where the unprocessed area data is stored 
calculate_lu_intensity_per_country(input_folder = input_folder, 
                                   output_folder = output_folder, 
                                   status_log_file=None,
                                   country_raster = country_raster,
